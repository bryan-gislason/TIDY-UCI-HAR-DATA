...
The rest of the columns is the mean (int) for the all of the observations of the subject and activity for the mean and std of all of the features, which can be found in the 'features.txt' file.
